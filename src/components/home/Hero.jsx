...
export default function Hero({ products = [], stats }) {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden px-5 pb-24 pt-14 sm:px-8 lg:pt-20"
    >
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div style={{ opacity: fade }}>
          ...
          >
            ...
            Festive drop live · {stats?.activeProducts ?? products.length}{" "}
            styles
          </motion.div>
          ...
          >
            VIMUHET designs small-batch essentials and festive ethnic wear in
            India. Pick a piece here, check out on the marketplace you already
            trust — Amazon, Flipkart, Meesho or Myntra. One tap, real reviews,
            real delivery.
          </motion.p>
          ...
          >
            {[
              ...
              <div key={item.label}>
                ...
                <dd className="mt-1 text-[0.6rem] uppercase tracking-[0.24em] text-cream/40">
                  {item.label}
                </dd>
              </div>
            ))}
        ...
        <div className="relative h-[30rem] sm:h-[36rem] lg:h-[42rem]">
          <div
            ...
            style={{
              background:
                "conic-gradient(from 120deg,#ff5d8f,#ffb15c,#8b5cff,#55e6c1,#ff5d8f)",
            }}
          />
          ...
          {a && (
            ...
            >
              ...
              <figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-ink to-transparent p-4">
                <p className="text-[0.6rem] uppercase tracking-[0.2em] text-cream/60">
                  {a.badge || "Featured"}
                </p>
          ...
          {c && (
            ...
            >
              ...
              <figcaption className="flex items-center justify-between gap-2 p-3">
                <span className="text-[0.65rem] uppercase tracking-[0.18em] text-cream/60">
                  {c.name}
                </span>
                <button
                  type="button"
              ...
              <svg viewBox="0 0 100 100" className="h-full w-full">
                ...
                <text className="fill-cream/70 text-[8.4px] uppercase tracking-[0.3em]">
                  <textPath href="#circlePath">
                    vimuhet · shop on amazon · flipkart · meesho ·
                  </textPath>
                </text>
              </svg>
            </div>
